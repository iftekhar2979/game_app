    ...
    <>
      <SafeAreaView className="flex-1 bg-black" edges={['top', 'bottom']}>
        ...
        >
          ...
          {isAdmin && (
            <TouchableOpacity
              className="flex-row items-center justify-between bg-[#2B2112] border border-[#E0B566]/40 rounded-[16px] px-5 py-4 mb-3"
              onPress={() => navigation.navigate('AdminCheer' as never)}
            >
              <View className="flex-row items-center">
                <Trophy color="#E0B566" size={20} className="mr-4" />
                <Text className="text-white text-[14px]">Cheer Operations</Text>
              </View>
              <ChevronRight color="#E0B566" size={20} />
            </TouchableOpacity>
          )}
      ...
      >
        <View className="flex-1 justify-center items-center px-6">
          ...
          <View className="w-full bg-white/10 rounded-[24px] p-6 items-center border border-white/20 shadow-2xl backdrop-blur-md">
            <Text className="text-white text-[24px] font-semibold mb-4">
              Logout
            </Text>
            <Text className="text-gray-300 text-[14px] text-center leading-5 mb-8">
              Are you want to sure logout now. If you logout now your all
              progress will be stop.
            </Text>
