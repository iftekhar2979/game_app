...
const AuthInput = ({ leftIcon, isPassword, style, error, ...props }: AuthInputProps) => {
  ...
  return (
    <View className="mb-4">
      <View className={`flex-row items-center bg-black border ${error ? 'border-red-500' : 'border-[#3A144E]'} rounded-xl px-4 py-4`}>
